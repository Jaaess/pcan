    ...
    public void run()
    {
        ...
        {            
            ...
            for (Object item : datatmp.values())
            {
                ...
                //System.out.println("size_______"+datatmp.size());
                msgIDStr = "";
                msgLength = "";
                msgType = "";
                msgData = "";
...
//                    }
                    //Index not found
                    if (msgIndex == -1/*lastRcvTime != msgRcvTime|| lastRcvTime == ""*/){
                        model.addRow(msgTableObect);
                       // lastRcvTime = msgRcvTime;
//                        System.out.println("time    "+msgRcvTime);
//                        System.out.println("rcvTime   "+lastRcvTime);
                        //System.out.println("model.addRow()_____datatmp.size"+datatmp.size());
                    }
...
//            datatmp.clear();
//            System.out.println("hello?    "+datatmp.size());
